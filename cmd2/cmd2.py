...
from .decorators import as_subcommand_to, with_argparser
...
from .utils import CompletionError, Settable, get_defining_class

# Set up readline
if rl_type == RlType.NONE:  # pragma: no cover
    sys.stderr.write(ansi.style_warning(rl_warning))
else:
    from .rl_utils import readline, rl_force_redisplay
...
class Cmd(cmd.Cmd):
    ...
    def _run_transcript_tests(self, transcript_paths: List[str]) -> None:
        ...
        if test_results.wasSuccessful():
            ...
            finish_msg = ' {} transcript{} passed in {:.3f} seconds '.format(num_transcripts, plural, execution_time)
